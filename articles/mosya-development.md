...
最終的にはデザインツールFigmaを使ってデザインデータより1からテキストの色や背景色、要素同士の間隔などを取得し、ランディングページなどをコーディングできるところまでを目指しておりそのための教材も用意しています。
...
![](https://storage.googleapis.com/zenn-user-upload/df78e18f64fb-20230503.png)
