...
録画したデモは、GIFよりもSVGで出力することを強くおすすめします！

SVGはGIFと比べてファイルサイズが圧倒的に軽量で、同じ内容でも1/10以下になることもあります。GitHubのリポジトリ容量を圧迫しないのは地味に嬉しいポイントですね。
...
プロダクトのLPにこれを埋め込むと、静的なスクリーンショットよりもずっとインパクトがあります。実際にコマンドを打っているようなアニメーションが流れるので、ユーザーに「使ってみたい」と思わせる効果があるんじゃないかなと思います。
